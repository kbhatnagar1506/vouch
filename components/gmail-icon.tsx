...
export function GmailIcon({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M0,0 L6,10 L24,38 L24,48 L6,48 Q0,48 0,42 Z" fill="#4285F4" />
      <path d="M48,0 L42,10 L24,38 L24,48 L42,48 Q48,48 48,42 Z" fill="#34A853" />
      <path d="M6,10 L14,0 L34,0 L42,10 L24,38 Z" fill="#EA4335" />
      <path d="M0,0 L14,0 L6,10 Z" fill="#C5221F" />
      <path d="M48,0 L34,0 L42,10 Z" fill="#FBBC04" />
    </svg>
  );
}
